                ...
                if (temp >= 30.0) {
                    ...
                    coolbutton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent i = new Intent(CPUCooler.this, Cpu_Scanner.class);
                            startActivity(i);
...
//                                Toast.makeText(getActivity(), "CPU Temperature is Already Normal", Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast toast = new Toast(CPUCooler.this);
...
//                recyclerView.getItemAnimator().setChangeDuration(1000);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            coolbutton = (ImageView)findViewById(R.id.coolbutton);
...
//TODO -if you Change Package name
                if (!packageName.equals("appsforyou.junkcleaner")) {
